...
VALUES
  (1, 1, 'Ремонт двигателя', 15000.00, 1),
  (1, 2, 'Замена колес', 2500.00, 2),
  (2, 2, 'Покраска капота', 7000.00, 3),
  (3, 4, 'Замена масла', 2000.00, 5),
  (4, 5, 'Ремонт КПП', 11000.00, 6),
  (5, 6, 'Полировка кузова', 3000.00, 8),
  (6, 6, 'Проверка тормозной системы', 5000.00, 10),
  (6, 8, 'Комплексное тех. обслуживание', 8000.00, 4),
  (7, 8, 'Диагностика электросистемы', 6500.00, 15),
  (8, 10, 'Чип-тюнинг двигателя', 17000.00, 9),
  (9, 4, 'Полная шумоизоляция салона', 12500.00, 7),
  (10, 3, 'Ремонт стартера', 7000.00, 15),
  (11, 3, 'Замена тормозных колодок', 4500.00, 10),
  (11, 3, 'Замена ремня ГРМ', 12000.00, 8),
  (12, 5, 'Перетяжка салона', 20000.00, 16),
  (13, 6, 'Антикоррозийная обработка', 8500.00, 14),
  (13, 6, 'Замена амортизаторов', 9500.00, 10),
  (13, 7, 'Диагностика подвески', 5500.00, 11),
  (14, 7, 'Промывка топливной системы', 5000.00, 13),
  (15, 8, 'Замена масла и фильтров', 3000.00, 5),
  (16, 1, 'Проверка тормозной системы', 3000.00, 10),
  (17, 1, 'Полировка фар', 2500.00, 8),
  (18, 3, 'Ремонт стартера', 6000.00, 15),
  (19, 6, 'Установка шумоизоляции', 7500.00, 7),
  (20, 6, 'Ремонт электрики', 9000.00, 15),
  (21, 7, 'Обслуживание кондиционера', 4000.00, 14),
  (22, 8, 'Замена тормозных дисков', 7000.00, 10),
  (22, 8, 'Проверка и регулировка развала', 2800.00, 11),
  (23, 9, 'Комплексное тех. обслуживание', 6200.00, 4),
  (24, 9, 'Антикоррозийная обработка днища', 7500.00, 14),
  (24, 1, 'Замена масла', 2600.00, 5),
  (24, 3, 'Диагностика подвески', 5000.00, 11),
  (25, 4, 'Ремонт электрики', 8500.00, 15),
  (26, 4, 'Замена тормозных дисков', 7500.00, 10),
  (27, 5, 'Комплексное тех. обслуживание', 6200.00, 4),
  (28, 5, 'Проверка тормозной системы', 3200.00, 10),
  (29, 7, 'Полировка кузова', 2800.00, 8),
  (30, 7, 'Ремонт стартера', 6200.00, 15),
  (30, 8, 'Проверка развала', 3000.00, 11),
  (30, 10, 'Чип-тюнинг', 9000.00, 9);
GO
